...
def parse_args():
    ...
    parser.add_argument('--model', type=str, default='fedavgshape',
    ...
    parser.add_argument('--threshold', type=float, default=0.4, help='threshold of HEAL 0.5digits 0.4caltech')
    parser.add_argument('--beta', type=float, default=0.6, help='momentum update beta')
