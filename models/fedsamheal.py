...
class FedSAMHEAL(FederatedModel):
    NAME = 'fedsamheal'
    COMPATIBILITY = ['homogeneity']

    def __init__(self, nets_list, args, transform):
        super(FedSAMHEAL, self).__init__(nets_list, args, transform)
        self.client_update = {}
    ...
    def loc_update(self, priloader_list):
        ...
        for i in online_clients:
            ...
            if self.args.wHEAL == 1:
                ...
                self.compute_distance(i, update_diff, param_names)
    ...
    def _train_net(self, index, net, train_loader):
        ...
        alpha = getattr(self.args, 'sam_rho', 0.05)
